...
public class SampleDataServletContextListener implements ServletContextListener {
    ...
    public void contextInitialized(ServletContextEvent servletContextEvent) {
        ...
        productDao.save(new Product(Product.generateId(), "1", "iPhone", new BigDecimal(10.0), Currency.getInstance("USD"), 1000));
        productDao.save(new Product(Product.generateId(),"2", "iPhone5", new BigDecimal(0), Currency.getInstance("USD"), 1));
        productDao.save(new Product(Product.generateId(),"3", "iPhoneX", new BigDecimal(100.0), Currency.getInstance("USD"), 100));
