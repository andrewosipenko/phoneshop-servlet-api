...
public class DemoDataServletContextListener implements ServletContextListener {
    ...
    private List<Product> getSampleProducts(){
        ...
        result.add(new Product("sgs", "Samsung Galaxy S I", new BigDecimal(100), usd, 100, "https://raw.githubusercontent.com/andrewosipenko/phoneshop-ext-images/master/manufacturer/Samsung/Samsung%20Galaxy%20S.jpg"));
        ...
        result.get(8).setPrice(BigDecimal.valueOf(100));
        result.get(8).setPrice(BigDecimal.valueOf(300));
        result.get(8).setPrice(BigDecimal.valueOf(1000));
