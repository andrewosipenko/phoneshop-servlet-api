...
public class ProductSampleDataListener implements ServletContextListener {
    ...
    public void contextInitialized(ServletContextEvent servletContextEvent) {
        ...
        if("listen".equals(servletContextEvent.getServletContext().getInitParameter("controlDataListener"))) {
            Currency usd = Currency.getInstance("USD");
            Map<String, BigDecimal> prices = new LinkedHashMap<>();
            prices.put("10.10.2011", new BigDecimal(300));
            prices.put("10.10.2015", new BigDecimal(200));
            prices.put("10.10.2019", new BigDecimal(100));
            ...
            prices.clear();
            prices.put("10.10.2011", new BigDecimal(400));
            prices.put("10.10.2015", new BigDecimal(300));
            prices.put("10.10.2019", new BigDecimal(200));
            ...
            prices.clear();
            prices.put("10.10.2011", new BigDecimal(500));
            prices.put("10.10.2015", new BigDecimal(400));
            prices.put("10.10.2019", new BigDecimal(300));
            ...
            prices.clear();
            prices.put("10.10.2011", new BigDecimal(1200));
            prices.put("10.10.2015", new BigDecimal(1100));
            prices.put("10.10.2019", new BigDecimal(1000));
            ...
            prices.put("10.10.2011", new BigDecimal(500));
            prices.put("10.10.2015", new BigDecimal(400));
            prices.put("10.10.2019", new BigDecimal(320));
            ...
            prices.clear();
            prices.put("10.10.2011", new BigDecimal(600));
            prices.put("10.10.2015", new BigDecimal(500));
            prices.put("10.10.2019", new BigDecimal(420));
            ...
            prices.put("10.10.2011", new BigDecimal(300));
            prices.put("10.10.2015", new BigDecimal(200));
            prices.put("10.10.2019", new BigDecimal(120));
            ...
            prices.clear();
            prices.put("10.10.2011", new BigDecimal(200));
            prices.put("10.10.2015", new BigDecimal(100));
            prices.put("10.10.2019", new BigDecimal(70));
            ...
            prices.put("10.10.2011", new BigDecimal(300));
            prices.put("10.10.2015", new BigDecimal(200));
            prices.put("10.10.2019", new BigDecimal(170));
            ...
            prices.put("10.10.2011", new BigDecimal(200));
            prices.put("10.10.2015", new BigDecimal(100));
            prices.put("10.10.2019", new BigDecimal(80));
            ...
            prices.put("10.10.2011", new BigDecimal(300));
            prices.put("10.10.2015", new BigDecimal(200));
            prices.put("10.10.2019", new BigDecimal(150));
