...
import com.es.phoneshop.utils.IdSeeker;
...
public class ArrayListProductDao implements ProductDao
{
    ...
    public ArrayListProductDao()
    {
        ...
        products.add(new Product(1L, "sgs", "Samsung Galaxy S", new BigDecimal(100), usd, 100,
                "https://raw.githubusercontent.com/andrewosipenko/phoneshop-ext-images/master/manufacturer/Samsung/Samsung%20Galaxy%20S.jpg"));
        products.add(new Product(2L, "sgs2", "Samsung Galaxy S II", new BigDecimal(200), usd, 0,
        ...
        products.add(new Product(3L, "sgs3", "Samsung Galaxy S III", new BigDecimal(300), usd, 5,
    ...
    {
        long[] ids = products.stream().mapToLong(Product::getId).toArray();
        Long id = IdSeeker.find(ids);
